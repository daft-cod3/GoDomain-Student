  ...
  hp: {
    icon: (
      <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
        <path d="M10 17s-7-4.35-7-9a4 4 0 0 1 7-2.65A4 4 0 0 1 17 8c0 4.65-7 9-7 9z" fill="currentColor" />
      </svg>
    ),
    color: "#e05c7a",
    ...
    >
      ...
      <div className="top-navbar-meter-body">
        <div className="top-navbar-meter-row">
          ...
          <strong className="top-navbar-meter-val">{value}<em>/{capacity}</em></strong>
        </div>
  ...
  return (
    <header className="top-navbar">
      ...
      <div className="top-navbar-stats" aria-label="Learner status">
        <NavbarMeter tone="hp" value={studentProfile.hp} capacity={studentProfile.hpCapacity} />
        <NavbarMeter tone="energy" value={studentProfile.energy} capacity={studentProfile.energyCapacity} />
        <Link
        ...
        >
          <span className="top-navbar-coins-icon" aria-hidden="true">
            <svg viewBox="0 0 20 20" fill="none">
              ...
              <text x="10" y="14" textAnchor="middle" fontSize="9" fontWeight="800" fill="#7b4d00">$</text>
            </svg>
          </span>
          <div className="top-navbar-coins-body">
            <span className="top-navbar-coins-label">Coins</span>
            <strong className="top-navbar-coins-val">{studentProfile.coins}</strong>
          </div>
        </Link>
      </div>
    </header>
