...
export const TRANSLATIONS = {
  ...
  luo: {
    ...
    roadSigns: {
      ...
      signs: {
        stop: { label: "Chung'", caption: "Chung' motegno kapok idhi e aora." },
        "give-way": { label: "Yie Jomoko Kadhi", description: "Yie joma ni e yoo ma nigi teko kadhi motelo." },
        "give-way": { label: "Yie Jomoko Kadhi", caption: "Yie joma ni e yoo ma nigi teko kadhi motelo." },
        "priority-road": { label: "Yoo mar Teko", caption: "Joma ni e yoo ma ni nigi teko e aora mabiro." },
        "end-priority-road": { label: "Giko Teko", caption: "Chuny mar teko orumo kendo aora mabiro dwaro neno matek." },
        "priority-over-oncoming": { label: "Teko Kuom Joma Biro", caption: "Iryom kadhi e chuny manok kapok joma biro." },
        "give-priority-to-oncoming": { label: "Mi Joma Biro Teko", caption: "Joma biro nigi teko mar kadhi mokwongo e chuny manok." },
        "no-entry": { label: "Ok Idonj", caption: "Ok otimo donj koa e lieto ma ni." },
        "no-parking": { label: "Ok Irag Gari", caption: "Ok irag gari e kama otemogi." },
        "no-stopping": { label: "Ok Ichung'", caption: "Ok ichung', rito, kata rag gari e kama ma ni." },
        "speed-limit-50": { label: "50 km/sa", caption: "Teko machielo ma chik yie en kilomita piero abich e sa achiel." },
        "no-u-turn": { label: "Ok Ilok Yo", caption: "Ok ilok yo e kama ma ni." },
        "no-overtaking": { label: "Ok Iwuogi Nyime", caption: "Ok otimo wuoth e nyim gari moro e kama ma ni." },
        "no-left": { label: "Ok Ilok Korachwich", caption: "Ok otimo loko korachwich e aora mabiro." },
        "no-left-turn": { label: "Ok Ilok Korachwich", caption: "Ok otimo loko korachwich e aora mabiro." },
        "no-horns": { label: "Ok Ikok Gogo", caption: "Kok gogo oriegni e kama ma ni." },
        "sharp-bend-left": { label: "Bend Matek", caption: "Bend matek ni e nyima kendo dwaro iriemb teko mokwongo." },
        "crossroad-ahead": { label: "Aora Achiel e Nyima", caption: "Aora achiel ni e nyima kendo gari moko nyalo biro." },
        "school-ahead": { label: "Skul e Nyima", caption: "Yot nyithindo, joma rit yoo, kod loko mapiyo e nyima." },
        "slippery-road": { label: "Yoo Mowil", caption: "Teko mar yoo nyalo lor, moloyo ka pula owuoyo kata gige moko." },
        "pedestrian-crossing": { label: "Lowo Mar Joo Wuotho", caption: "Lowo ma otemogi ni machiegni kendo joo nyalo donj e yoo." },
        "steep-descent": { label: "Lor Matek", caption: "Chuny mar lor e nyima nyalo medho teko mar gari mapiyo." },
        "narrow-bridge": { label: "Aunda Manok", caption: "Aunda mabiro oriegni boro mar yoo kod chuny." },
        parking: { label: "Kama Rag Gari", caption: "Kama rag gari ma chik yie ni e nyima kata e but yoo." },
        hospital: { label: "Osiptal", caption: "Tiend osiptal ni machiegni." },
        "bus-stop": { label: "Kama Bus Ochung'", caption: "Bus mag oganda ochung' kae kata machiegni." },
        "fuel-station": { label: "Kama Petrol", caption: "Petrol kod kony mar tiend tich ni machiegni." },
        "one-way": { label: "Yoo Achiel", caption: "Gari e yoo ma ni gidhiye e lieto achiel kende." },
        "first-aid": { label: "Kony Mar Mokwongo", caption: "Kony mar thuolo man machiegni." },
        "pedestrian-subway": { label: "Yoo Mar Piny Joo Wuotho", caption: "Yoo mar piny mar joo wuotho ni machiegni." },
      },
    },
    learningPath: {
      monday: "Wuok tich",
