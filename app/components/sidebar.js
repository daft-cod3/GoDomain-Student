...
const NAV_ITEMS = [
  { id: "dashboard", label: "Dashboard", href: "/",         caption: "Uploads & progress", icon: "dashboard" },
  { id: "learn",     label: "Learn",     href: "/content",  caption: "Lessons & units",    icon: "learn"     },
  { id: "profile",   label: "Profile",   href: "/stats",    caption: "Details & coins",    icon: "profile"   },
  { id: "settings",  label: "Settings",  href: "/settings", caption: "Theme & tools",      icon: "settings"  },
];
...
function Icon({ name }) {
  ...
  if (name === "learn") return (
    <svg {...base} strokeWidth="1.9">
      ...
      <path d="M6 12.5V17c0 1.657 2.686 3 6 3s6-1.343 6-3v-4.5" strokeLinecap="round" />
  ...
  return <svg {...base} strokeWidth="1.9"><circle cx="12" cy="12" r="4" /></svg>;
}
...
export default function Sidebar({ active = "dashboard" }) {
  ...
  return (
    <aside
      ...
      onBlur={handleBlur}
    >
      <div className={`sb-panel sb-panel--refined${expanded ? " expanded" : ""}`} id="app-sidebar">

        {/* ── Brand ── */}
        <Link className="sb-brand" href="/" title="GoDomain dashboard">
          <span className="sb-brand-mark" aria-hidden="true">
            <Image src="/godomain-logo.svg" alt="GoDomain" width={20} height={20} priority />
          </span>
        ...
        <div className="sb-footer sb-text">
          ...
          <Link className="sb-cta" href="/content">Continue learning</Link>
        </div>
